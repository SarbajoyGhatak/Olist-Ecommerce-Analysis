...
SELECT
    ...
    CASE r.state
        ...
        WHEN 'GO' THEN -16.6869
        WHEN 'PE' THEN  -8.0539
        WHEN 'CE' THEN  -3.7172
        WHEN 'PA' THEN  -1.4558
        WHEN 'MA' THEN  -2.5297
        WHEN 'MT' THEN -15.6014
        WHEN 'MS' THEN -20.4428
        WHEN 'PB' THEN  -7.1195
        WHEN 'RN' THEN  -5.7945
        WHEN 'AL' THEN  -9.6658
        WHEN 'PI' THEN  -5.0920
        WHEN 'ES' THEN -20.3155
        WHEN 'DF' THEN -15.7801
    ...
    CASE r.state
        ...
        WHEN 'GO' THEN -49.2648
        WHEN 'PE' THEN -34.8811
        WHEN 'CE' THEN -38.5434
        WHEN 'PA' THEN -48.5044
        WHEN 'MA' THEN -44.3028
        WHEN 'MT' THEN -56.0974
        WHEN 'MS' THEN -54.6462
        WHEN 'PB' THEN -34.8641
        WHEN 'RN' THEN -35.2110
        WHEN 'AL' THEN -35.7350
        WHEN 'PI' THEN -42.8019
        WHEN 'ES' THEN -40.3128
        WHEN 'DF' THEN -47.9292
        WHEN 'SE' THEN -37.0731
        WHEN 'AM' THEN -60.0212
        WHEN 'RO' THEN -63.9004
    ...
    -- colour tier: top 7 green, middle 10 yellow, bottom 10 red
    CASE
    ...
    -- numeric score for Power BI colour scale
    CASE
